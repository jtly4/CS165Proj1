...
# - Each function should return the number of comparisons as described below.
# - insertion_sort should return the number of element comparisons in the sorting.
# - tim_sort should return the number of element comparisons while merging two runs.
# - Each of the shell_sorts should return the number of element comparisons while sorting.
# - Do not count any other comparisons!
# Note:
